...
var UserRoleWhere = struct {
	...
	ID:     whereHelperint{field: "\"user_role\".\"id\""},
...
var (
	userRoleAllColumns            = []string{"id", "user_id", "role_id"}
...
func (q userRoleQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UserRole, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boilmodels: failed to execute a one query for user_role")
	}
...
func (q userRoleQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserRoleSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boilmodels: failed to assign all query results to UserRole slice")
	}
...
func (q userRoleQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: failed to count user_role rows")
	}
...
func (q userRoleQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boilmodels: failed to check if user_role exists")
	}
...
func FindUserRole(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UserRole, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boilmodels: unable to select from user_role")
	}
...
func (o *UserRole) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boilmodels: no user_role provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boilmodels: unable to insert into user_role")
	}
...
func (o *UserRole) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boilmodels: unable to update user_role, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: unable to update user_role row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: failed to get rows affected by update for user_role")
	}
...
func (q userRoleQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: unable to update all for user_role")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: unable to retrieve rows affected for user_role")
	}
...
func (o UserRoleSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: unable to update all in userRole slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: unable to retrieve rows affected all in update all userRole")
	}
	return rowsAff, nil
}
...
func (o *UserRole) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boilmodels: no user_role provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("boilmodels: unable to upsert user_role, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boilmodels: unable to upsert user_role")
	}
...
func (o *UserRole) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boilmodels: no UserRole provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: unable to delete from user_role")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: failed to get rows affected by delete for user_role")
	}
...
func (q userRoleQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boilmodels: no userRoleQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: unable to delete all from user_role")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: failed to get rows affected by deleteall for user_role")
	}
...
func (o UserRoleSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boilmodels: unable to delete all from userRole slice")
	}
...
func (o *UserRoleSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boilmodels: unable to reload all in UserRoleSlice")
	}
...
func UserRoleExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boilmodels: unable to check if user_role exists")
	}
